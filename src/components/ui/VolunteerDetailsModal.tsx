                ...
                >
                    ...
                    >
                        ...
                        <div className="vol-detail-modal__body">
                                ...
                                {volunteer.spiritual_journey && (
                                    <div className="vol-detail-section">
                                        <h3 className="vol-detail-section__title">
                                            <BookOpen size={15} /> Spiritual Journey / Testimony
                                        </h3>
                                        <div 
                            ...
                            {/* Right Column - Actions & Attendance History */}
                            <div className="vol-detail-modal__actions-col">
                                {/* Admin Actions Section */}
                                <div className="vol-detail-admin-card glass-strong">
                                    ...
                                    <div className="vol-detail-admin-actions">
                                        ...
                                        <hr className="vol-detail-admin-divider" />
                                        <button 
                                ...
                                <div className="vol-detail-attendance-card glass-strong">
